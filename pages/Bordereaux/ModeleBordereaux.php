...
// Ensure UTF-8 output in HTTP response
...
// ---- Date formatting to French long form ----
...
function asLetters($n, $sep = '.')
{
    return (string) $n; // stub; real function not used in the view
}
